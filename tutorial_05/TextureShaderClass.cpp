...
{
	// 정점 및 픽셀 쉐이더를 초기화합니다
	return InitializeShader(device, hwnd, L"../tutorial_05/Texture.vs", L"../tutorial_05/Texture.ps");
}
...
bool TextureShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, PCWCHAR vsFileName, PCWCHAR psFileName)
{
	HRESULT result;
...
void TextureShaderClass::OutputShaderErrorMessage(ID3D10Blob* errorMessage, HWND hwnd, PCWCHAR shaderFileName)
{
	// 에러 메세지를 출력창에 표시합니다
