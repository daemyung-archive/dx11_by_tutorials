...
{
	// 정점 및 픽셀 쉐이더를 초기화합니다
	return InitializeShader(device, hwnd, L"../tutorial_17/MultiTexture.vs", L"../tutorial_17/MultiTexture.ps");
}
...
bool MultiTextureShaderClass::Render(ID3D11DeviceContext* deviceContext, int indexCount, XMMATRIX worldMatrix, XMMATRIX viewMatrix, XMMATRIX projectionMatrix, ID3D11ShaderResourceView** textureArray)
{
...
bool MultiTextureShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, PCWCHAR vsFileName, PCWCHAR psFileName)
{
	HRESULT result;
...
void MultiTextureShaderClass::OutputShaderErrorMessage(ID3D10Blob* errorMessage, HWND hwnd, PCWCHAR shaderFileName)
{
	// 에러 메세지를 출력창에 표시합니다
...
bool MultiTextureShaderClass::SetShaderParameters(ID3D11DeviceContext* deviceContext, XMMATRIX worldMatrix, XMMATRIX viewMatrix, XMMATRIX projectionMatrix, ID3D11ShaderResourceView** textureArray)
{
